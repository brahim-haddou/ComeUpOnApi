"""
Django settings for ComeUpOn project.
...
ALLOWED_HOSTS = ['192.168.43.10', 'localhost', '127.0.0.1']

# Application definitionls
...
WSGI_APPLICATION = 'ComeUpOn.wsgi.application'
